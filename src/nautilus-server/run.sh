...
echo "127.0.0.70   dfusion-ollama.var-meta.com" >> /etc/hosts
echo "127.0.0.71   dfusion-qdrant.var-meta.com" >> /etc/hosts
echo "127.0.0.72   localhost:11434" >> /etc/hosts
echo "127.0.0.73   localhost:6333" >> /etc/hosts
